<%@ page language="java" contentType="text/html; charset=UTF-8"
          ...
          *********************************************************************************************************************************************************** -->
          ...
          <section id="main-content">
           ...
           <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 center  "><div class="hm-100"></div></div>
            ...
            <div class="col-lg-4 col-md-4 col-xs-12 col-sm-12 center "><div class="hm-picture"><a href="paihangbang.html"><img class="img-responsive center-block " src="${path}assets/img/movies/1.jpg" width="150" height="210"/></a></div></div>
    ...
    <div class="hm-div2">段小楼（张丰毅）与程蝶衣（张国荣）是一对打小一起长大的师兄弟，两人一个演生，一个饰旦，一向配合天衣无缝，尤其一出《霸王别姬》，更是誉满京城，为此，两人约定合演一辈子《霸王别姬》。但两人对戏剧与人生关系的理解有本质不同，段小楼深知戏非人生，程蝶衣则是人戏不分。 
    　　段小楼在认为该成家立业之时迎娶了名妓菊仙（巩俐），致使程蝶衣认定菊仙是可耻的第三者，使段小楼做了叛徒，自此，三人围绕一出《霸王别姬》生出的爱恨情仇战开始随着时代风云的变迁不断升级，终酿成悲剧。 </div>
    <div class="hm-div3">6.8分 (26748人评价)</div></div>
    ...
    <div class="hm-fenmame"><a href="#"> 灾难</a><a href="#">   &nbsp;武侠</a><a href="#">   &nbsp;古装</a><a href="#">   &nbsp;运动</a><a href="#">   &nbsp;黑色电影</a></div></div>
      <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 ">
    <div  class="hm-picture1"><a href="#"><img class="img-responsive center-block" src="${path}assets/img/movies/38.jpg" width="300" height="280"/></a></div></div>
     ...
     <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 "><div class="hm-160"><img src="${path}assets/img/movies/36.png" class="img-responsive center-block" height="90" width="90"/></div><div class="hm-20"></div>
       <div class="hm-50">
         <div class="hm-105"><div class="hm-25"></div><div class="hm-80"><img src="${path}assets/img/movies/37.png" class="img-responsive center-block" height="45" width="45"/></div>
       </div></div>
       ...
       <div class="hm-picture2"><div class="hm-left"><a href="#"><img src="${path}assets/img/movies/8.jpg" class="img-responsive center-block" width="65" height="91"/></a></div><div class="hm-filmname">你好，疯子！</div> </div></div>
         <div class="col-lg-3 col-md-3 col-xs-6 col-sm-6 ">
       <div class="hm-picture2"><div class="hm-left"><a href="#"><img src="${path}assets/img/movies/8.jpg" class="img-responsive center-block" width="65" height="91"/></a></div><div class="hm-filmname">你好，疯子！</div> </div></div>
         <div class="col-lg-3 col-md-3 col-xs-6 col-sm-6 ">
       <div class="hm-picture2"><div class="hm-left"><a href="#"><img src="${path}assets/img/movies/8.jpg" class="img-responsive center-block" width="65" height="91"/></a></div><div class="hm-filmname">你好，疯子！</div> </div></div>
        <div class="col-lg-3 col-md-3 col-xs-6 col-sm-6 ">
       <div class="hm-picture2"><div class="hm-left"><a href="#"><img src="${path}assets/img/movies/8.jpg" class="img-responsive center-block" width="65" height="91"/></a></div><div class="hm-filmname">你好，疯子！</div> </div></div></div>
